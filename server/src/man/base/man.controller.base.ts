...
export class ManControllerBase {
  constructor(
  ...
  @swagger.ApiCreatedResponse({ type: Man })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Body() data: ManCreateInput,
  ...
  @swagger.ApiOkResponse({ type: [Man] })
  @swagger.ApiForbiddenResponse()
  @ApiNestedQuery(ManFindManyArgs)
  async findMany(
    @common.Req() request: Request,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<Man[]> {
    const args = plainToClass(ManFindManyArgs, request.query);
  ...
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async findOne(
    @common.Param() params: ManWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<Man | null> {
    const permission = this.rolesBuilder.permission({
      role: userRoles,
