...
export class WomanControllerBase {
  constructor(
  ...
  @swagger.ApiCreatedResponse({ type: Woman })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Body() data: WomanCreateInput,
  ...
  @swagger.ApiOkResponse({ type: [Woman] })
  @swagger.ApiForbiddenResponse()
  @ApiNestedQuery(WomanFindManyArgs)
  async findMany(
    @common.Req() request: Request,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<Woman[]> {
    const args = plainToClass(WomanFindManyArgs, request.query);
  ...
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async findOne(
    @common.Param() params: WomanWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<Woman | null> {
    const permission = this.rolesBuilder.permission({
      role: userRoles,
